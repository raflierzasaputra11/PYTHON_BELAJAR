...
print("====INTEGER====")
data_int = 9;
print("data = ", data_int, "data = ", type(data_int))

data_float = float(data_int)
data_str   = str(data_int)
data_bool  = bool(data_int) #akan false jika nilai int = 0
print("data = ", data_float, "data = ", type(data_float))
print("data = ", data_str, "data = ", type(data_str))
print("data = ", data_bool, "data = ", type(data_bool))
